...
description: You can generate a comma-separated values (CSV) text file from an XML file. This article provides examples for C# and Visual Basic.
ms.date: 07/20/2015
dev_langs:
  - "csharp"
  - "vb"
...
The C# version uses method syntax and the `Aggregate` operator to generate the file in a single expression. For more information, see [Query Syntax and Method Syntax in LINQ](../../csharp/programming-guide/concepts/linq/query-syntax-and-method-syntax-in-linq.md).  
